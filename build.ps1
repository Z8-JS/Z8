...
$linkFlags = @(
    ...
    "build\main.obj", "build\temporal_shims.obj", "build\console.obj", "build\fs.obj", "build\path.obj", "build\os.obj", "build\process.obj", "build\util.obj", "build\timer.obj", "build\buffer.obj", "build\zlib.obj", "build\events.obj", "build\stream.obj",
...
$sources = @("src/main.cpp", "src/temporal_shims.cpp", "src/module/console.cpp", "src/module/node/fs/fs.cpp", "src/module/node/path/path.cpp", "src/module/node/os/os.cpp", "src/module/node/process/process.cpp",    "src/module/node/util/util.cpp",
    ...
    "src/module/node/stream/stream.cpp",
